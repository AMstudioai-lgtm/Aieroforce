  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none select-none">
      {/* 
        ...
        - Mobile : Moitié Haute (h-[52%] top-0)
        - Desktop : Moitié Droite (md:w-1/2 md:h-full md:left-1/2 md:top-0)
      */}
      <div className="absolute inset-x-0 top-0 h-[52%] md:inset-y-0 md:left-1/2 md:right-0 md:w-1/2 md:h-full z-0 bg-[#0c0d11]" />

      {/* 
        PANNEAU NOIR SOMBRE :
        - Mobile : Moitié Basse (h-[48%] bottom-0, z-20)
        - Desktop : Moitié Gauche (md:w-1/2 md:h-full md:left-0 md:top-0, z-20)
      */}
      <div
        className="absolute inset-x-0 bottom-0 h-[48%] md:inset-y-0 md:left-0 md:w-1/2 md:h-full z-20 pointer-events-auto bg-[#08080A] shadow-[0_-8px_24px_rgba(0,0,0,0.85)] md:shadow-[6px_0_24px_rgba(0,0,0,0.85)]"
      >
      ...
      {/* 
        LIGNE DE SÉPARATION :
        - Mobile : Horizontale à top: 52%
        - Desktop : Verticale à left: 50%
      */}
      <div className="absolute left-0 right-0 top-[52%] h-px md:hidden bg-white/15 z-25 pointer-events-none shadow-[0_0_8px_rgba(255,255,255,0.15)]" />
